...
OUTPUT_FILE = "/home/vngbthang/IE212.Q21.1_BigDataLAB/LAB3/output_bai4.txt"
...
print("Top 20 movie-age_group theo avg rating:")
for row in top_20:
    print(row)

with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
    f.write("Top 20 movie-age_group theo avg rating:\n")
    for row in top_20:
        f.write(f"{row}\n")
